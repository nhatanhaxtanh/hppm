...
// cac mo hinh du an HPPM dong hanh quan ly - van hanh
export const partners: Partner[] = [
    {
        name: 'Quản lý chung cư',
        image: '/skyresidence.jpg',
    },
    {
        name: 'Vận hành khu dân cư',
        image: '/lavela.jpg',
    },
    {
        name: 'Quản lý khu biệt thự',
        image: '/cove.jpg',
    },
    {
        name: 'Bảo trì hệ thống kỹ thuật',
        image: '/imperial/imperial-20.jpg',
    },
    {
        name: 'Chăm sóc cảnh quan',
        image: '/ecoxuan/ECOXUAN-177.jpg',
    },
    {
        name: 'Không gian cộng đồng cư dân',
        image: '/residents.jpg',
    },
];

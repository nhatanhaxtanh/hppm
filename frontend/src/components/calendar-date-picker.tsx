    ...
    (
            ...
            if (part === 'from') {
                if (years.includes(newYear)) {
                    const newMonth = monthFrom
                        ? new Date(
                              newYear,
                              monthFrom ? monthFrom.getMonth() : 0,
                              1,
                          )
        ...
        const handleWheel = (event: React.WheelEvent, part: string) => {
            ...
            if (highlightedPart === 'firstDay') {
                ...
                const newMonthIndex =
                    currentMonth + (event.deltaY > 0 ? -1 : 1);
        ...
        React.useEffect(() => {
            ...
            const firstMonthElement = document.getElementById(
                `firstMonth-${id}`,
            );
            const firstYearElement = document.getElementById(`firstYear-${id}`);
            const secondDayElement = document.getElementById(`secondDay-${id}`);
            const secondMonthElement = document.getElementById(
                `secondMonth-${id}`,
            );
            const secondYearElement = document.getElementById(
                `secondYear-${id}`,
            );
                                ...
                                <div className="flex flex-col">
                                    <div className="flex items-center gap-4">
                                        <div className="ml-3 flex gap-2">
                                            ...
                                            >
                                                <SelectTrigger className="hover:bg-accent hover:text-accent-foreground w-[122px] font-medium focus:ring-0 focus:ring-offset-0">

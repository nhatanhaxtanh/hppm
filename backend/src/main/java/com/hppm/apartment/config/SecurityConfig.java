...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception {
        ...
        String[] publicEndpoints =
                Arrays.stream(baseEndpoints).map(endpoint -> endpoint).toArray(String[]::new);
        httpSecurity
    ...
    // JwtAuthenticationConverter serves as a crucial bridge between JWT token claims and Spring
    // Security's authorization system.
    // it takes raw JWT payload and converts it into format that Spring Security expects
    @Bean
    public JwtAuthenticationConverter jwtAuthenticationConverter() {
        // This converter examines your JWT's claims and extracts authorities based on specific
        // patterns.
        // By default, it looks for claims named "scope" or "scp" and treats them as space-separated
